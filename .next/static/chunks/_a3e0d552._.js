...
"[project]/components/terminal/OzoneTerminal.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const uid = ()=>"".concat(Date.now(), "_").concat(Math.random().toString(36).slice(2, 6));
// ─── Boot sequence ────────────────────────────────────────────────────────────
const BOOT_LINES = [
    {
...
function OzoneTerminal() {
    ...
    const [cmdHistory, setCmdHistory] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [cmdIdx, setCmdIdx] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(-1);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "OzoneTerminal.useEffect": ()=>{
            let mounted = true;
            BOOT_LINES.forEach({
                "OzoneTerminal.useEffect": (param)=>{
                    let { content, type, delay } = param;
                    setTimeout({
                        "OzoneTerminal.useEffect": ()=>{
                            if (!mounted) return;
                            setLines({
                                "OzoneTerminal.useEffect": (prev)=>[
                                        ...prev,
                                        {
                                            id: uid(),
                                            type,
    ...
    const addLine = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "OzoneTerminal.useCallback[addLine]": function(type, content) {
            let partial = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false;
            const id = uid();
            setLines({
                "OzoneTerminal.useCallback[addLine]": (prev)=>[
                        ...prev,
                        {
                            id,
                            type,
            ...
            }["OzoneTerminal.useCallback[addLine]"]);
            return id;
        }
    }["OzoneTerminal.useCallback[addLine]"], []);
    const appendToLine = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "OzoneTerminal.useCallback[appendToLine]": (id, chunk)=>{
            setLines({
                "OzoneTerminal.useCallback[appendToLine]": (prev)=>prev.map({
                        "OzoneTerminal.useCallback[appendToLine]": (l)=>l.id === id ? {
                                ...l,
                                content: l.content + chunk
                            } : l
                    }["OzoneTerminal.useCallback[appendToLine]"])
            }["OzoneTerminal.useCallback[appendToLine]"]);
        }
    }["OzoneTerminal.useCallback[appendToLine]"], []);
    const finalizeStream = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "OzoneTerminal.useCallback[finalizeStream]": (id)=>{
            setLines({
                "OzoneTerminal.useCallback[finalizeStream]": (prev)=>prev.map({
                        "OzoneTerminal.useCallback[finalizeStream]": (l)=>l.id === id ? {
                                ...l,
                                partial: false,
                                type: 'output'
                            } : l
                    }["OzoneTerminal.useCallback[finalizeStream]"])
            }["OzoneTerminal.useCallback[finalizeStream]"]);
        }
    }["OzoneTerminal.useCallback[finalizeStream]"], []);
    // ── Submit ─────────────────────────────────────────────────────────────────
    const submit = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "OzoneTerminal.useCallback[submit]": async (raw)=>{
            var // Cancel any in-flight request
            _abortRef_current;
            const msg = raw.trim();
            if (!msg || streaming) return;
            setCmdHistory({
                "OzoneTerminal.useCallback[submit]": (h)=>[
                        msg,
                        ...h.slice(0, 49)
                    ]
            }["OzoneTerminal.useCallback[submit]"]);
            setCmdIdx(-1);
            setInput('');
            addLine('input', msg);
            ...
            const streamId = uid();
            setLines({
                "OzoneTerminal.useCallback[submit]": (prev)=>[
                        ...prev,
                        {
                            id: streamId,
                            type: 'stream',
            ...
            try {
                ...
                if (!res.ok || !res.body) throw new Error("HTTP ".concat(res.status));
                ...
                while(true){
                    ...
                    var _parts_pop;
                    buf = (_parts_pop = parts.pop()) !== null && _parts_pop !== void 0 ? _parts_pop : '';
                    for (const part of parts){
                        ...
                        try {
                            ...
                            if (parsed.error) {
                                setLines({
                                    "OzoneTerminal.useCallback[submit]": (prev)=>prev.map({
                                            "OzoneTerminal.useCallback[submit]": (l)=>l.id === streamId ? {
                                                    ...l,
    ...
    const onKeyDown = (e)=>{
        ...
        if (e.key === 'ArrowUp') {
            ...
            setCmdIdx(next);
            var _cmdHistory_next;
            setInput((_cmdHistory_next = cmdHistory[next]) !== null && _cmdHistory_next !== void 0 ? _cmdHistory_next : '');
        }
        if (e.key === 'ArrowDown') {
            e.preventDefault();
            const next = cmdIdx - 1;
            setCmdIdx(next);
            var _cmdHistory_next1;
            setInput(next < 0 ? '' : (_cmdHistory_next1 = cmdHistory[next]) !== null && _cmdHistory_next1 !== void 0 ? _cmdHistory_next1 : '');
        }
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])('relative flex flex-col', 'bg-[#080810] border border-oz-border rounded-sm', 'h-[460px] lg:h-[520px]', 'font-mono text-sm', // CRT scanline overlay
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    lines.map((line)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(TerminalLine, {
                            line: line
                        }, line.id, false, {
                            fileName: "[project]/components/terminal/OzoneTerminal.tsx",
                            lineNumber: 213,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                        ...
                        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])('flex-1 bg-transparent text-oz-text text-sm', 'placeholder:text-oz-text-3/30', 'focus:outline-none', 'caret-oz-cyan', streaming && 'opacity-50'),
                        autoComplete: "off",
                        spellCheck: false
                    }, void 0, false, {
                        fileName: "[project]/components/terminal/OzoneTerminal.tsx",
                    ...
                    input && !streaming && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
_s(OzoneTerminal, "eWpp55EjOCjpgeGQz0SLiPKt9XE=");
_c = OzoneTerminal;
// ─── Individual Line ──────────────────────────────────────────────────────────
function TerminalLine(param) {
    let { line } = param;
    ...
    if (line.type === 'input') {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                    className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])(base, 'text-oz-cyan'),
    ...
    if (line.type === 'system') {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
            className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])(base, 'text-oz-text-3'),
            children: line.content
        }, void 0, false, {
            fileName: "[project]/components/terminal/OzoneTerminal.tsx",
            lineNumber: 261,
    ...
    if (line.type === 'error') {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
            className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])(base, 'text-oz-red'),
            children: line.content
        }, void 0, false, {
            fileName: "[project]/components/terminal/OzoneTerminal.tsx",
            lineNumber: 265,
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])(base, 'text-oz-text-2'),
        children: [
            line.content,
            line.partial && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
__turbopack_context__.k.register(_c1, "TerminalLine");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$terminal$2f$OzoneTerminal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/terminal/OzoneTerminal.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/utils.ts [app-client] (ecmascript)");
;
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        ...
                                                        mounted && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$terminal$2f$OzoneTerminal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OzoneTerminal"], {}, void 0, false, {
                                                            fileName: "[project]/app/page.tsx",
                                                            lineNumber: 334,
                                                            columnNumber: 31
                                                        }, this)
...
//# sourceMappingURL=_a3e0d552._.js.map